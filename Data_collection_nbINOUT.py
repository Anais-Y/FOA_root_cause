...
def col_before_and_after(data, distances):
    ...
    for k in data.index:
        ...
        INOUT.append(consumption)
    return before_consumption, after_consumption, INOUT
...
def FOA_main():
    ...
    before_consumption, after_consumption, INOUT=col_before_and_after(data, distances)
