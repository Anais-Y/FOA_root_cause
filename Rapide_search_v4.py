...
if __name__=='__main__':
    os.chdir('c:/Users/223102584/Box/Doc_Xin/Sujet_Principale/Cold_head/')
    data_ref = pd.read_excel('SS_4_classes.xlsx')
    data2 = data_ref[['failed_part_no','family_name']]
    data2 = data2.groupby(['failed_part_no']).count()
    data2 = data2[data2['family_name']>0]
    col_data = data2.index.astype(str)
